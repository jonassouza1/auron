  ...
  describe("Anonymous user", () => {
    it("With unique and Valid data", async () => {
      const response = await fetch("http://localhost:3000/api/v1/users", {
        ...
        body: JSON.stringify({
          username: "jonas souza",
          email: "jonassouza305@yahoo.com.br",
          password: "senha123",
          points: 4,
        }),
      });
      ...
      const userInDatabase = await user.findOneByUsername("jonas souza");
    ...
    it("With duplicated 'username'", async () => {
      const response1 = await fetch("http://localhost:3000/api/v1/users", {
        ...
        body: JSON.stringify({
          username: "nomeduplicado1",
          email: "jon@email.com.br",
          password: "senha123",
          points: 4,
        }),
      });
